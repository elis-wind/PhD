...
for word in words:
    ...
    # Google search
    url2 = "https://www.google.com/search?channel=fs&client=ubuntu&q="+word+" этимология"

    # Wikitionary
    url3 = "https://ru.wiktionary.org/wiki/"+word+"#Этимология"
    ...
    # Etymology varous sources
    url7 = "https://lexicography.online/etymology/"+letter+"/"+word
